...
public class RadonTransformer extends Transformer<TransformerConfig>
{
	/**
	 * 0 = None
	 * 1 = Light
	 ...
	 * 3 = Combined
	 */
	public static int FLOW_MODE = 3;
	/**
	 * 0 = None
	 * 1 = Legacy
	 * 2 = New
	 */
	public static int NUMBER_MODE = 2;
	/**
	 * 0 = None
	 * 1 = Legacy
	 * 2 = New
	 */
	public static int STRING_POOL_MODE = 2;
	public static boolean INDY = true;
	public static boolean STRING = true;
	public static boolean TRASH_CLASSES = false;
